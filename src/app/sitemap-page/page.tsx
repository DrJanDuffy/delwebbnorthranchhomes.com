...
const sitePages = [
  ...
  },
  {
    ...
    pages: [
      ...
      { href: "/community/las-vegas-arts-district-midtown", label: "Arts District & Midtown", description: "First Friday, galleries, and cultural outings from North Las Vegas" },
